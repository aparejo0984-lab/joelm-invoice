...
execSync('php bin/console assets:install public', output);
execSync('php bin/console fos:js-routing:dump --format=json --target=assets/js/js_routes.json', output);
execSync('php bin/console bazinga:js-translation:dump assets/js --merge-domains --format=json', output);
